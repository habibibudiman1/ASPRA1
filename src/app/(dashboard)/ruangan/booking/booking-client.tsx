...
// =============================================================================
// app/(dashboard)/ruangan/booking/booking-client.tsx
...
import { cekBookingBentrok } from '@/lib/actions/ruangan-actions'
    ...
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          {errors.ruangan_id && (
            <p className="text-xs text-destructive">{errors.ruangan_id.message}</p>
          )}
        </div>
          ...
          <Card className="bg-muted/30">
            <CardContent className="pt-4 pb-4">
              <div className="flex flex-wrap gap-2">
                ...
                {selectedRuangan.fasilitas.map(f => (
                  <Badge key={f} variant="outline" className="text-xs">{f}</Badge>
                ))}
              </div>
              {selectedRuangan.keterangan && (
                <p className="text-xs text-muted-foreground mt-2">{selectedRuangan.keterangan}</p>
              )}
            </CardContent>
          </Card>
        )}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            {errors.jam_mulai && (
              <p className="text-xs text-destructive">{errors.jam_mulai.message}</p>
            )}
          </div>
          <div className="space-y-2">
            ...
            {errors.jam_selesai && (
              <p className="text-xs text-destructive">{errors.jam_selesai.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.jumlah_peserta && (
            <p className="text-xs text-destructive">{errors.jumlah_peserta.message}</p>
          )}
        </div>
